...
//todo tplData may have to be declared inside handlers to hold different data for each session
var tplData = new(TplData)
...
func index(w http.ResponseWriter, r *http.Request) {
	...
	if ok {
		switch val {
		case "loggedIn":
			tplData.T["loginStatus"] = "logged in"
		default:
			tplData.T["loginStatus"] = "not logged in"
		}
	...
	// TODO these should be global in production for performance - template caching
...
func login(w http.ResponseWriter, r *http.Request) {
	...
	if ok {
		...
		case "loggedOut":
			...
			err = htmlTpl.ExecuteTemplate(w, "login.html", nil)
			if err != nil {
...
func loginFail(w http.ResponseWriter, r *http.Request) {
	...
	err := htmlTpl.ExecuteTemplate(w, "loginfail.html", nil)
	if err != nil {
